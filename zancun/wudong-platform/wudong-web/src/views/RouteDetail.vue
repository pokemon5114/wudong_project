...
/* 路线内容保持原有层级，统一“衣”详情页的字体和配色。 */
.route-detail-page { background:#f8f5ed; color:#13243d; }.detail-hero { height:clamp(300px,32vw,450px); }.detail-hero .hero-overlay { background:linear-gradient(90deg,rgba(19,36,61,.78),rgba(19,36,61,.28)); }.detail-hero .hero-content { max-width:1280px; padding-inline:clamp(32px,7vw,116px); text-align:left; }.detail-hero .route-type { border-radius:0!important; color:#fffdf8!important; background:#b88722!important; }.detail-hero h1 { font-family:'Noto Serif SC',serif; font-size:clamp(42px,4.6vw,68px); font-weight:500; letter-spacing:-.065em; text-shadow:none; }.detail-hero p { color:#fffdfa; }
.breadcrumb { padding:30px 0 12px; }.breadcrumb :deep(.el-breadcrumb__inner) { color:#6d7988; font-weight:600; }.breadcrumb :deep(.el-breadcrumb__item:last-child .el-breadcrumb__inner) { color:#183653; }.route-content { max-width:1280px; margin:auto; }.route-overview.card,.fee-card.card,.notice-card.card,.spot-card.card { border:1px solid rgba(19,36,61,.1)!important; border-radius:0!important; background:transparent!important; box-shadow:none!important; }.route-overview { gap:clamp(34px,5vw,70px); padding:clamp(28px,4vw,52px)!important; }.overview-image,.overview-image .cover-image { border-radius:0!important; }.quick-info .info-icon { color:#bf9126!important; background:rgba(201,152,39,.1)!important; }.quick-info .info-label { color:#758294!important; }.quick-info .info-value { color:#183653!important; }.price-section { padding-block:22px; border-block:1px solid rgba(19,36,61,.16); background:transparent!important; }.price-tag .currency,.price-tag .amount { color:#183653!important; font-family:Georgia,'Times New Roman',serif; font-variant-numeric:tabular-nums; }.book-btn { border-color:#183653!important; border-radius:999px!important; background:#183653!important; }.book-btn:hover { background:#285678!important; }.consult-btn { border-color:#c99827!important; border-radius:999px!important; color:#9b741e!important; background:transparent!important; }
.route-section { margin-top:clamp(58px,7vw,96px); }.section-header { padding-bottom:14px; border-bottom:1px solid rgba(19,36,61,.16); }.section-header h2 { font-family:'Noto Serif SC',serif; color:#183653; font-size:clamp(27px,3vw,39px); font-weight:500; letter-spacing:-.05em; }.section-header h2::after { background:#c99827!important; }.schedule-day,.fee-card,.notice-card { box-shadow:none!important; }.day-badge { background:#183653!important; }.timeline-dot { border-color:#c99827!important; background:#fffdfa!important; }.timeline-content,.notice-item p,.notice-item li { color:#687587!important; }.spot-card:hover { transform:translateY(-5px); box-shadow:0 14px 30px rgba(19,36,61,.12)!important; }.spot-image,.spot-image img { border-radius:0!important; }.spot-number { border-radius:0!important; background:#b88722!important; }.spot-info h4 { font-family:'Noto Serif SC',serif; color:#183653!important; font-weight:500; }.fee-header { color:#183653!important; }.fee-header .el-icon,.fee-card li .el-icon { color:#bf9126!important; }
</style>
