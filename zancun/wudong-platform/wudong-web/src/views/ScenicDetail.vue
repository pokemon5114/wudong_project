...
/* 景区内容不变，颜色与版式回到统一的米白、靛蓝、鎏金语境。 */
.scenic-detail-page { background:#f8f5ed; color:#13243d; }.page-hero { height:clamp(300px,32vw,450px); }.page-hero .hero-overlay { background:linear-gradient(90deg,rgba(19,36,61,.76),rgba(19,36,61,.26)); }.page-hero .hero-content { padding-bottom:clamp(42px,5vw,78px); }.page-hero h1 { font-family:'Noto Serif SC',serif; font-size:clamp(42px,4.6vw,68px); font-weight:500; letter-spacing:-.065em; text-shadow:none; }.type-tag { border-radius:0!important; background:#b88722!important; border:0!important; }.hero-meta { color:#fffdfa!important; }
.detail-layout { gap:clamp(28px,4vw,60px); margin-top:clamp(34px,5vw,68px)!important; }.card.section,.buy-card { border:1px solid rgba(19,36,61,.1)!important; border-radius:0!important; background:transparent!important; box-shadow:none!important; }.section { padding:clamp(25px,3vw,42px)!important; }.section-header { padding-bottom:14px; border-bottom:1px solid rgba(19,36,61,.16); }.section-header h2 { font-family:'Noto Serif SC',serif; color:#183653; font-size:clamp(27px,3vw,39px); font-weight:500; letter-spacing:-.05em; }.section-header h2::after { background:#c99827!important; }.intro { color:#687587; line-height:2; }.tags :deep(.el-tag) { border-color:#d3a535; color:#a87a19; background:transparent; }.gallery-item { border-radius:0!important; }
.buy-card { padding:30px!important; border-top:1px solid rgba(19,36,61,.18)!important; }.price-block { padding-bottom:19px; border-bottom:1px solid rgba(19,36,61,.16); }.price-block .price { color:#183653!important; font-family:Georgia,'Times New Roman',serif; font-size:clamp(42px,4vw,58px)!important; font-variant-numeric:tabular-nums; }.price-block .free { color:#476c58!important; }.field label { color:#526276; font-weight:700; }.scenic-detail-page :deep(.el-input__wrapper) { background:#fffdfa; box-shadow:0 0 0 1px rgba(19,36,61,.16) inset; }.buy-btn { border-color:#183653!important; border-radius:999px!important; background:#183653!important; }.buy-btn:hover { background:#285678!important; }.contact { color:#687587!important; }
</style>
